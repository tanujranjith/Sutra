...
| `workspace/` | `business-workspace.js`, `handwriting.js`, `notifications.js`, `daily-lock-in-quote.js` | Projects & Work, handwriting/drawing, the notification center, and the daily quote. |
