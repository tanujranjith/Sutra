...
(function (scope) { scope.SUTRA_ASSET_MANIFEST = Object.freeze({
  ...
  "critical": [
    ...
    "./src/config/feature-manifest.js?v=20260716-syncwipe1",
    "./src/config/sutra-runtime-config.js?v=20260716-sync6",
    "./src/core/app.js?v=20260721-runtime-recovery3",
    ...
    "./src/features/workspace/today-command-center.js?v=20260703-today1",
