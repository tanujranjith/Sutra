...
(function (scope) { scope.SUTRA_ASSET_MANIFEST = Object.freeze({
  ...
  "critical": [
    ...
    "./src/features/notes/editor-v2.js?v=20260708-editorv2-p6",
    ...
    "./src/features/workspace/mobile-nav.js?v=20260723-unified1",
    ...
    "./src/features/workspace/timeline-drag.js?v=20260721-drag2",
    ...
    "./src/persistence/workspace-db.js?v=20260714-idb-factory1",
    ...
    "./src/sync/sync-projection.js?v=20260716-syncparity1",
    ...
    "./styles/responsive/mobile.css?v=20260723-unified1",
