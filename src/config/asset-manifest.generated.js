...
(function (scope) { scope.SUTRA_ASSET_MANIFEST = Object.freeze({
  ...
  "critical": [
    ...
    "./src/components/icons/icon-paths.js?v=20260809-audit-icons1",
    "./src/components/icons/index.js?v=20260809-audit-icons1",
    "./src/config/feature-manifest.js?v=20260809-helpdocs2",
    "./src/config/sutra-runtime-config.js?v=20260716-sync6",
    "./src/core/app.js?v=20260809-helpdocs1",
    ...
    "./src/features/study/homework.js?v=20260809-audit1",
    ...
    "./src/features/workspace/theme-presets-refresh.js?v=20260809-theme-cohesion1",
    ...
    "./styles/base/styles.css?v=20260807-onboardingflow1",
    ...
    "./styles/responsive/mobile.css?v=20260809-audit-mobile1",
