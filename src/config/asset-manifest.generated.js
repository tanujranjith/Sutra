...
(function (scope) { scope.SUTRA_ASSET_MANIFEST = Object.freeze({
  ...
  "critical": [
    ...
    "./src/config/feature-manifest.js?v=20260807-surfaces2",
    "./src/config/sutra-runtime-config.js?v=20260716-sync6",
    "./src/core/app.js?v=20260807-canvas1",
    ...
    "./src/features/workspace/canvas-workbench.js?v=20260807-canvas1",
    ...
    "./src/features/workspace/timeline-calendar.js?v=20260807-ics1",
    ...
    "./src/sync/sync-merge.js?v=20260807-duress1",
    ...
    "./styles/features/cloud-sync.css?v=20260807-scrollcontain1",
